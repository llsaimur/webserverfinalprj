...
<body>
<div class="center" >
<h1>Game Level 1: Order 6 letters in ascending order</h1>
<?php
...
<form action="../src/functions/level1_process.php" method="post">
...
<p><a href="../message/game_history.php?from=level1">View Game History</a></p>
